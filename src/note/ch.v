...
Proof with (compute; auto 20; solve_notin).
  all: try apply (der_abs _ "Hx__Mx" _ _ _ "*")...
  all: try apply (der_abs _ "Hsocrates" _ _ _ "*")...
  1: apply (
    der_app
      _
      _
  ...
  all: try apply (der_prod _ _ "*" "Hx__Mx" _ "*" _)...
  all: try apply (der_var _ "*" _ "Hx__Mx")...
  all: remove_var "Hx__Mx" "*".

  all: try apply (der_prod _ _ "*" "x" _ "*" _)...

  all: try apply (der_prod _ _ "*" "Hx" _ "*" _)...
  all: remove_var "Hx" "*".

  all: try apply (der_prod _ _ "*" "Hsocrates" _ "*" _)...
  all: try apply (der_var _ "*" _ "Hsocrates")...
  all: remove_var "Hsocrates" "*".
